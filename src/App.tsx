  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-3xl px-4 sm:px-8 flex flex-col items-center gap-6 sm:gap-10">
        ...
        {/* Progress Counter - Professional with Decimal */}
        <motion.div
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Right Content - Professional Computer Screen Illustration */}
          <motion.div
...
function CoursesSection({ setCurrentPage, coursesList }: { setCurrentPage: (page: Page) => void, coursesList: Course[] }) {
  const { t } = useTranslation();
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-3xl mx-auto">
            ...
            <div className="relative flex-1 group">
              <div className="absolute inset-0 bg-gradient-to-r from-purple-600/20 to-indigo-600/20 rounded-xl blur opacity-0 group-focus-within:opacity-100 transition-opacity" />
              ...
              <input
                ...
                className="relative w-full pl-12 pr-4 py-3 bg-gray-800/80 backdrop-blur-sm border border-purple-500/30 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-purple-500/60 focus:ring-2 focus:ring-purple-500/20 transition-all text-base"
              />
            </div>
            ...
            <div className="relative group">
              ...
              <select
                ...
                className="relative w-full sm:w-40 pl-12 pr-10 py-3 bg-gray-800/80 backdrop-blur-sm border border-purple-500/30 rounded-xl text-white appearance-none cursor-pointer focus:outline-none focus:border-purple-500/60 focus:ring-2 focus:ring-purple-500/20 transition-all font-medium text-base"
              >
                <option value="all" className="bg-gray-900 text-white">{t('courses.all')}</option>
                <option value="beginner" className="bg-gray-900 text-white">{t('courses.beginner')}</option>
                <option value="intermediate" className="bg-gray-900 text-white">{t('courses.intermediate')}</option>
                <option value="advanced" className="bg-gray-900 text-white">{t('courses.advanced')}</option>
              </select>
              <ChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-purple-400 pointer-events-none" />
            </div>
            
            {/* Results Count */}
            <div className="flex items-center justify-center px-4 py-3 bg-gray-800/50 border border-white/10 rounded-xl text-sm text-gray-400 whitespace-nowrap">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Progress Chart - Professional Design */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(t('common.error') + ': ' + (data.message || 'Invalid credentials'));
      }
    } catch (err) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © 2026 CodeMaster. {t('footer.copyright')}.
          </p>
...
function App() {
  ...
  const [coursesList, setCoursesList] = useState<Course[]>(courses); // Fallback to static
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        ...
        if (response.ok) {
          const data = await response.json();
          if (data.length > 0) setCoursesList(data);
        }
      } catch (err) {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'courses':
        return <CoursesSection setCurrentPage={setCurrentPage} coursesList={coursesList} />;
      case 'dashboard':
